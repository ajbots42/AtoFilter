...
BOT_TOKEN = environ.get('BOT_TOKEN', "7111574318:AAEoFybaiXt56BEYjM-7i48fQEr-PfnwRVQ")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/Ctl.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1170337923').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002351071755')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002391486356')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002045014432')).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://BOTMAKERS6:/BOTMAKERS6@cluster0.a2dbeeo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "sivaoriginals")  # Changed to sivaoriginals
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'sofiles')  # Changed to sofiles
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "")  # Necessary If clone



# Additional Settings
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mb_request')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SivaOriginals')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mb_request')  # Support Chat Link Without https:// or @

# Bot Settings (True or False values)
...
SHORTLINK_API = environ.get('SHORTLINK_API', '9e99a38c5adbc1e748c69ec5599392b82dca48ad')
TUTORIAL = environ.get('TUTORIAL', '')  # How to Open Shortner Link Video Link, Channel Link Where You Upload Your Video.
